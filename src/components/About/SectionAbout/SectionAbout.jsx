      ...
      <section className={classes.container}>
        ...
        <div className={classes.containerLinks}>
          <div className={classes.divLink}>
            <img src='./public/vk.svg' alt="Логотип вк" />
            <a href="#" className={classes.link}>Ссылка на наш паблик</a>
          </div>
          <div className={classes.divLink}>
            <img src='./public/maks.svg' alt="Логотип макс" />
            <a href="#" className={classes.link}>Ссылка на наш Макс</a>
          </div>
          <div className={classes.divLink}>
            <img src='./public/inst.svg' alt="Логотип Инстаграмм" />
            <a href="#" className={classes.link}>Ссылка на наш Инстаграмм</a>
          </div>
          <div className={classes.divLink}>
            <img src='./public/youTube.svg' alt="Логотип Ютуб" />
            <a href="#" className={classes.link}>Ссылка на наш Ютуб</a>
          </div>
          <div className={classes.divLink}>
            <img src='./public/telega.svg' alt="Логотип Телеграм" />
            <a href="#" className={classes.link}>Ссылка на наш Телеграм</a>
          </div>
          <div className={classes.divLink}>
            <img src='./public/twitter.svg' alt="Логотип Твиттер" />
            <a href="#" className={classes.link}>Ссылка на наш Твиттер</a>
          </div>
        </div>
        <iframe src="https://yandex.ru/map-widget/v1/?um=constructor%3A3edec1e6966efbf16dba8b1a4993aa6e978615cce943105fa27d00da3ceeb53c&amp;source=constructor" width="500" height="500" frameborder="0"></iframe>
      </section>
